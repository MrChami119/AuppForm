...
class WelcomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Handle file uploads
        $cebBillPath = $request->file('ceb_bill_image')->store('ceb_bills', 'public'); // Store in public/ceb_bills
        $idImagePath = $request->file('id_image')->store('id_images', 'public'); // Store in public/id_images
        $bankBookPath = $request->file('bank_book_image')->store('bank_books', 'public'); // Store in public/bank_books
